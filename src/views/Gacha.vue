  ...
  <div id="content-wrapper" class="d-flex flex-column">
    <div id="content">
      ...
      <div class="container-fluid mt-4">
        ...
        <img class="img-fluid mx-auto d-block mb-4" :src="`https://${this.$store.getters.configs.api.app.host}${this.$store.getters.configs.api.app.path}images/gacha/${this.$route.params.key}.png?${this.$store.getters.randomStr}`" width="800" :alt="$t('ui.text.event_wish_image')" v-if="isDisplayEventImage(this.$route.params.key)">
