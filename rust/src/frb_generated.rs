...
flutter_rust_bridge::frb_generated_boilerplate!(
                ...
                pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1765935392;
...
fn wire__crate__api__capture__ping_impl(ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,rust_vec_len_: i32,data_len_: i32) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
            ...
            deserializer.end();
                transform_result_sse::<_, ()>((move || {
                     let output_ok = Result::<_,()>::Ok(crate::api::capture::ping())?;   Ok(output_ok)
                })()) })
            }
...
// Section: dart2rust
        ...
        return ans_;}
                ...
                fn pde_ffi_dispatcher_sync_impl(
                    ...
                    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
                    match func_id {
                        1 => wire__crate__api__capture__ping_impl(ptr, rust_vec_len, data_len),
                        _ => unreachable!(),
                    }
                }
